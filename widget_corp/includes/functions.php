<?php
	...
	// navigation takes two arguments the currently selected subject array or null and 
	// currently selected page array or null.
	function navigation($subject_array,$page_array)
	{
		...
		{ 
			// For highlighting the selected subject
			$output.= "<li";
			...
			while($page=mysqli_fetch_assoc($page_set))
				{
					// For highlighting the selected page
					$output.=  "<li";
					if($page_array && $page["id"]==$page_array["id"])  //We might get null or a page with an id
					{
						$output.=  " class=\"selected\"";
					}
